...
class Dialog_box:
    def __init__(self, render):
        ...
        self.font = pygame.font.Font(resource_path('assets/graphics/font/youyuan.ttf'), 25)
        ...
        # talker icon
        self.talker_image = pygame.image.load(resource_path('assets/graphics/npcs/npc_1_face.png'))
    ...
    def add_line(self, text):
        self.text = text
        if len(self.multiline) <= self.multiline_max_line:
